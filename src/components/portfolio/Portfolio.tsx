...
const projects: Project[] = [
  {
    ...
    year: "2025",
    challenge:
      "Marca regional com produto de altíssimo padrão, mas comunicação aquém do mercado de luxo.",
    solution:
      "Sistema visual editorial, paleta restrita e fotografia arquitetônica para reposicionar a marca no segmento premium.",
    accent: true,
  },
  {
    n: "02",
    ...
    year: "2025",
    challenge:
      "Valorizar marcenaria fina em um portfólio digital saturado de fotos genéricas de móvel.",
    solution:
      "Captação DSLR com luz natural lateral, recortes arquitetônicos e tratamento monocromático sutil.",
  },
  {
    n: "03",
    title: "Studio Rosso",
    ...
    year: "2020 — 2024",
    challenge:
      "Lançar uma marca autoral de arte e design em um mercado dominado por reprodução em escala.",
    solution:
      "Curadoria minimalista, assinatura visual consistente e venda direta ao consumidor final.",
    accent: true,
  },
  {
    n: "04",
    ...
    year: "2026",
    challenge:
      "Garantir consistência da marca entre showroom físico, social media e materiais impressos.",
    solution:
      "Guia visual modular, kit de templates e biblioteca fotográfica padronizada.",
  },
];
